          ...
          {/* ส่วนข้อมูล */}
            <section>
              <span className="inline-flex pl-10">
                  <h1 className="text-blue-600 pt-2 font-semibold text-xl hover:underline underline-offset-4 decoration-2 pr-3"><a href="beamdosanan-e3vb.vercel.app">จัดการรายชื่อนักเรียน</a></h1>
            ...
            <section>
              <div className="pl-10">
                ...
                <button className="text-blue-700 rounded-xl w-28 h-8 ring ring-blue-700 ring-offset-0 hover:bg-blue-700 hover:text-white m-10 text-bold">
                  <a href="beamdosanan-e3vb.vercel.app">ย้อนกลับ</a>
                </button>
              </div>
            </section>
        </div>
